...
public class ImageUndistortion{
	...
	public void doImageUndstortion(){
		...
		// done : adapt the paths
		int caseNo = 0;
		String filename = "/proj/i5dmip/ax78imaq/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/frame32.jpg";
		
		if(caseNo == 0)
		{
			filename = "/proj/i5dmip/ax78imaq/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/frame32.jpg";
		}
		else if(caseNo == 1)
		{
			filename = "/proj/i5dmip/ax78imaq/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/undistorted.jpg";
		}else if(caseNo == 2)
		{
			filename = "/proj/i5dmip/ax78imaq/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/frame90.jpg";
		}
		...
		// DOne: define the number of lattice points
		// change the value of nx, ny
		int nx = 8;
		int ny = 8;
		
		// step size
		// DOne: calculate the stepsize of the lattice points 
		float fx = (imSize / nx);
		float fy = (imSize / ny);
		...
		for(int i = 0; i < ny; i++)
		{
			for(int j = 0; j < nx; j++)
			{
				//DOne: sample the distorted and undistorted grid points at the lattice points
